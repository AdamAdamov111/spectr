...
export const TYPE_ICONS: Record<ObjectType, ComponentType<LucideProps>> = {
  ...
  GridArea: Mountain, Substation: Cog, PowerLine: Route, LineSegment: Minus, Feeder: Drill, Refinery: Factory, Terminal: Anchor,
}
