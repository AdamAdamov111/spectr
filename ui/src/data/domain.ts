...
export const DOMAINS: Record<DomainKey, DomainSpec> = {
  oilgas: {
    key: 'oilgas', label: 'Нефтегаз и трубопроводный транспорт', holding: 'Северная нефть', holdingFull: 'ПАО «Северная нефть»',
    dzo: [
      { key: 'a', name: 'СН-Добыча', kind: 'добыча', erp: 'SAP ECC 6.0', region: 'ХМАО — Югра', emp: 4200 },
      { key: 'b', name: 'СН-Транспорт', kind: 'транспорт', erp: '1С:ERP + 1С:ТОиР', region: 'ХМАО — Югра', emp: 2100 },
      { key: 'c', name: 'СН-Переработка', kind: 'переработка', erp: '1С:ERP', region: 'Тюменская область', emp: 3300 },
    ],
    hubType: 'PumpStation', distType: 'Tank', unitType: 'Well', areaType: 'Field', linearType: 'Pipeline', linearUnit: 'м³/ч',
    legend: [{ color: '#9d8be8', label: 'скважины' }, { color: '#4c90f0', label: 'НПС и резервуары' }, { color: '#e76a6e', label: 'аномалии и инциденты' }, { color: '#abb3bf', label: 'техника' }],
    ...
    agentSuggest: ['Какие подрядчики НПС-2 связаны с ООО Вектор и сорвали сроки за квартал?', 'Какое оборудование откажет первым?', 'Справка по ООО Стрела', 'Что известно о Насос-104?', 'Кто такой Иванов И.И.?'],
    scenarioQuestion: 'Какие подрядчики НПС-2 связаны с ООО Вектор и сорвали сроки за квартал?', scenarioKeywords: ['нпс-2', 'нпс 2'],
    savedQueries: [{ label: 'Насосы с индексом < 0.5', type: 'Equipment', pred: 'health' }, { label: 'Контрагенты с риском > 0.6', type: 'Organization', pred: 'risk' }, { label: 'Просроченные договоры', type: 'Contract', pred: 'overdue' }, { label: 'Открытые заявки ТОиР', type: 'MaintenanceOrder', pred: 'open' }, { label: 'Закупки с картельным паттерном', type: 'Procurement', pred: 'cartel' }, { label: 'Скважины с падением дебита', type: 'Well', pred: 'trend' }],
    unitLabelInWork: 'скважин в работе',
    layerLabels: { fields: 'Месторождения', pipelines: 'Трубопроводы (поток ∝ расходу)', wells: 'Скважины и кусты', nps: 'НПС', tanks: 'Резервуары (уровень)', vehicles: 'Техника (ГЛОНАСС)', anomalies: 'Аномалии', incidents: 'Инциденты', heat: 'Тепловая карта рисков контрагентов' },
  ...
  energy: {
    ...
    layerLabels: { fields: 'Районы сетей (РЭС)', pipelines: 'ЛЭП (поток ∝ перетоку)', wells: 'Фидеры и ПС 35 кВ', nps: 'ПС 220 кВ', tanks: 'ПС 110 кВ (загрузка)', vehicles: 'Бригады ОВБ (ГЛОНАСС)', anomalies: 'Аномалии', incidents: 'Технологические нарушения', heat: 'Тепловая карта рисков контрагентов' },
